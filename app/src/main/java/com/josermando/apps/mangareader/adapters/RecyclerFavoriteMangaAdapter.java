 ...
 */
public class RecyclerFavoriteMangaAdapter extends RecyclerView.Adapter<RecyclerFavoriteMangaAdapter.MyViewHolder>{

    private List<Manga> mangaList;
    private LayoutInflater mInflater;
    Context context;

    public RecyclerFavoriteMangaAdapter(Context context, List<Manga> mangaList) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            manager.beginTransaction().replace(R.id.site_container, mangaChapterFragment).addToBackStack("FavoriteManga").commit();
        }
    }
}
